"""Tests de validation OKF — 18 règles (F001, F002, R001, R002,
...
# ---------------------------------------------------------------------------
# R001 — frontmatter interdit dans index.md
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# R002 — heading de date non ISO dans log.md
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# F101 — type hors des types déclarés
# ---------------------------------------------------------------------------
...
class TestF103:
    def test_triggers_when_status_present_on_forbidden_type(
        ...
        m = load_manifest(manifest_path)
        assert m.profile is not None
        # JournalEntry has status_values=False → statut interdit
        diags = check_profile(
            "doc.md",
            {
                "type": "JournalEntry",
...
class TestF105:
    def test_triggers_on_invalid_status_value(
        ...
        diags = check_profile(
            ...
            {
                "type": "Decision",
                "statut": "EnCours",  # not in [Accepté, Proposé, Déprécié]
                "created": "2026-01-01",
            },
            m.profile,
            m.base.status_field,
...
# ---------------------------------------------------------------------------
# F106 — graphie du type non normalisée (alias)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# F201 — champ inconnu dans le frontmatter
# ---------------------------------------------------------------------------
